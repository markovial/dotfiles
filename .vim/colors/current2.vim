...
let g:colors_name = "vim-1337"

" User Options
if !exists("g:vim_1337_italic")
    let g:vim_1337_italic = 0
endif

if g:vim_1337_italic
...
let s:white          = {"cterm": 000         , "gui": "#E8EDF0"}
let s:black          = {"cterm": 000         , "gui": "#181616"}
let s:yellow_light   = {"cterm": 000         , "gui": "#000000"}
let s:yellow_medium  = {"cterm": 000         , "gui": "#000000"}
let s:yellow_dark    = {"cterm": 000         , "gui": "#000000"}
let s:orange_light   = {"cterm": 000         , "gui": "#FFC135"}
let s:orange_medium  = {"cterm": 000         , "gui": "#FF7E00"}
let s:orange_dark    = {"cterm": 000         , "gui": "#000000"}
let s:red_light      = {"cterm": 000         , "gui": "#000000"}
let s:red_medium     = {"cterm": 000         , "gui": "#CC0000"}
let s:red_dark       = {"cterm": 000         , "gui": "#000000"}
let s:blue_light     = {"cterm": 000         , "gui": "#000000"}
let s:blue_medium    = {"cterm": 000         , "gui": "#00ACC1"}
let s:blue_dark      = {"cterm": 000         , "gui": "#000000"}
let s:gray_light     = {"cterm": 000         , "gui": "#A2A1A1"}
let s:gray_medium    = {"cterm": 000         , "gui": "#747373"}
let s:gray_dark      = {"cterm": 000         , "gui": "#464444"}
let s:purple_light   = {"cterm": 000         , "gui": "#000000"}
let s:purple_medium  = {"cterm": 000         , "gui": "#000000"}
let s:purple_dark    = {"cterm": 000         , "gui": "#000000"}
let s:green_light    = {"cterm": 000         , "gui": "#000000"}
let s:green_medium   = {"cterm": 000         , "gui": "#73D216"}
let s:green_dark     = {"cterm": 000         , "gui": "#000000"}
